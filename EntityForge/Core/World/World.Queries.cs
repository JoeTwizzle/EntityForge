...
partial class World
{
    ...
    /// </summary>
    public ReadOnlySpan<ArchetypeFilter> Filters => new ReadOnlySpan<ArchetypeFilter>(_filters, 0, _filterCount);
    /// <summary>
    /// lock
    /// </summary>
    ...
    /// </summary>
    private readonly Dictionary<ComponentMask, int> _filterMap;
    /// <summary>
    /// Stores all filters by their creation meta
    /// </summary>
    private ArchetypeFilter[] _filters;
