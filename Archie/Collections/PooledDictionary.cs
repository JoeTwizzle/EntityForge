...
// Original Code from https://github.com/jtmueller/Collections.Pooled
...
{
    /// <summary>
    /// Used internally to control behavior of insertion into a <see cref="FastPooledDictionary{TKey, TValue}"/>.
    /// </summary>
    ...
    /// <remarks>
    /// A <see cref="FastPooledDictionary{TKey,TValue}"/> can support multiple readers concurrently, as long as the collection is not modified. 
        ...
        ISerializable, IDisposable
    {
        ...
        /// </summary>
        public FastPooledDictionary() : this(0, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(ClearMode clearMode) : this(0, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(int capacity) : this(capacity, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(int capacity, ClearMode clearMode) : this(capacity, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEqualityComparer<TKey> comparer) : this(0, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(int capacity, IEqualityComparer<TKey> comparer) : this(capacity, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(ClearMode clearMode, IEqualityComparer<TKey> comparer) : this(0, clearMode, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(int capacity, ClearMode clearMode, IEqualityComparer<TKey> comparer)
        {
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IDictionary<TKey, TValue> dictionary) : this(dictionary, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IDictionary<TKey, TValue> dictionary, ClearMode clearMode) : this(dictionary, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) : this(dictionary, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IDictionary<TKey, TValue> dictionary, ClearMode clearMode, IEqualityComparer<TKey> comparer) :
            this(dictionary?.Count ?? 0, clearMode, comparer)
        {
            ...
            if (dictionary is FastPooledDictionary<TKey, TValue> pooled)
            {
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
            : this(collection, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, ClearMode clearMode)
            : this(collection, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
            : this(collection, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, ClearMode clearMode, IEqualityComparer<TKey> comparer) :
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<(TKey key, TValue value)> collection)
            : this(collection, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<(TKey key, TValue value)> collection, ClearMode clearMode)
            : this(collection, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<(TKey key, TValue value)> collection, IEqualityComparer<TKey> comparer)
            : this(collection, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(IEnumerable<(TKey key, TValue value)> collection, ClearMode clearMode, IEqualityComparer<TKey> comparer)
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary((TKey key, TValue value)[] array)
            : this(array.AsSpan(), ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary((TKey key, TValue value)[] array, ClearMode clearMode)
            : this(array.AsSpan(), clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary((TKey key, TValue value)[] array, IEqualityComparer<TKey> comparer)
            : this(array.AsSpan(), ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary((TKey key, TValue value)[] array, ClearMode clearMode, IEqualityComparer<TKey> comparer)
            : this(array.AsSpan(), clearMode, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(ReadOnlySpan<(TKey key, TValue value)> span)
            : this(span, ClearMode.Auto, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(ReadOnlySpan<(TKey key, TValue value)> span, ClearMode clearMode)
            : this(span, clearMode, null) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(ReadOnlySpan<(TKey key, TValue value)> span, IEqualityComparer<TKey> comparer)
            : this(span, ClearMode.Auto, comparer) { }

        /// <summary>
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        public FastPooledDictionary(ReadOnlySpan<(TKey key, TValue value)> span, ClearMode clearMode, IEqualityComparer<TKey> comparer)
...
#pragma warning disable IDE0060 // Remove unused parameter
        ...
        /// Creates a new instance of PooledDictionary.
        /// </summary>
        protected FastPooledDictionary(SerializationInfo info, StreamingContext context)
#pragma warning restore IDE0060
        ...
        /// <summary>
        /// Gets an item by refrence in the dictionary by key.
        /// </summary>
...
#pragma warning restore IDE0059
        ...
        {
            private readonly FastPooledDictionary<TKey, TValue> _dictionary;
            ...
            internal Enumerator(FastPooledDictionary<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection(FastPooledDictionary<TKey, TValue> dictionary)
            {
            ...
            public struct Enumerator : IEnumerator<TKey>, IEnumerator
            {
                ...
                internal Enumerator(FastPooledDictionary<TKey, TValue> dictionary)
                {
                    _dictionary = dictionary;
                    _version = dictionary._version;
                    _index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection(FastPooledDictionary<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
